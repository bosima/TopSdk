...
{
    /// <summary>
    /// TOP API: dingtalk.oapi.kac.datav.telconf.detail.list
    /// </summary>
    public class OapiKacDatavTelconfDetailListRequest : BaseDingTalkRequest<DingTalk.Api.Response.OapiKacDatavTelconfDetailListResponse>
    {
        /// <summary>
        /// 请求参数对象
        /// </summary>
