...
{
    /// <summary>
    /// TOP API: dingtalk.oapi.robot.message.statistics.listbypushid
    /// </summary>
    public class OapiRobotMessageStatisticsListbypushidRequest : BaseDingTalkRequest<DingTalk.Api.Response.OapiRobotMessageStatisticsListbypushidResponse>
    {
        /// <summary>
        /// 群Id列表
        /// </summary>
