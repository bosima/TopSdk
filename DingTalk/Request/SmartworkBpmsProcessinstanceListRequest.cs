...
{
    /// <summary>
    /// TOP API: dingtalk.smartwork.bpms.processinstance.list
    /// </summary>
    public class SmartworkBpmsProcessinstanceListRequest : BaseDingTalkRequest<DingTalk.Api.Response.SmartworkBpmsProcessinstanceListResponse>
    {
        /// <summary>
