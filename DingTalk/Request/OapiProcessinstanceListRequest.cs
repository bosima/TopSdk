...
{
    /// <summary>
    /// TOP API: dingtalk.oapi.processinstance.list
    /// </summary>
    public class OapiProcessinstanceListRequest : BaseDingTalkRequest<DingTalk.Api.Response.OapiProcessinstanceListResponse>
    {
        /// <summary>
