...
{
    /// <summary>
    /// TOP API: dingtalk.oapi.kac.datav.videoconf.detail.list
    /// </summary>
    public class OapiKacDatavVideoconfDetailListRequest : BaseDingTalkRequest<DingTalk.Api.Response.OapiKacDatavVideoconfDetailListResponse>
    {
        /// <summary>
        /// 请求参数对象
        /// </summary>
