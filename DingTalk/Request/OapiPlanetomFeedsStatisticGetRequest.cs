...
{
    /// <summary>
    /// TOP API: dingtalk.oapi.planetom.feeds.statistic.get
    /// </summary>
    public class OapiPlanetomFeedsStatisticGetRequest : BaseDingTalkRequest<DingTalk.Api.Response.OapiPlanetomFeedsStatisticGetResponse>
    {
        /// <summary>
        /// 主播在对应组织的id(staffId)
        /// </summary>
