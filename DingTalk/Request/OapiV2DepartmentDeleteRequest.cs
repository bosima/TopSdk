...
{
    /// <summary>
    /// TOP API: dingtalk.oapi.v2.department.delete
    /// </summary>
    public class OapiV2DepartmentDeleteRequest : BaseDingTalkRequest<DingTalk.Api.Response.OapiV2DepartmentDeleteResponse>
    {
        /// <summary>
