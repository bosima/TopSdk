...
{
    /// <summary>
    /// TOP API: dingtalk.oapi.crm.objectdata.customobject.update
    /// </summary>
    public class OapiCrmObjectdataCustomobjectUpdateRequest : BaseDingTalkRequest<DingTalk.Api.Response.OapiCrmObjectdataCustomobjectUpdateResponse>
    {
        /// <summary>
        /// 自定义对象数据
        /// </summary>
