...
{
    /// <summary>
    /// TOP API: dingtalk.oapi.hrm.employee.delandhandover
    /// </summary>
    public class OapiHrmEmployeeDelandhandoverRequest : BaseDingTalkRequest<DingTalk.Api.Response.OapiHrmEmployeeDelandhandoverResponse>
    {
        /// <summary>
        /// 确认离职对象
        /// </summary>
