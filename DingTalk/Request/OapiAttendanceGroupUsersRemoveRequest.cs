...
{
    /// <summary>
    /// TOP API: dingtalk.oapi.attendance.group.users.remove
    /// </summary>
    public class OapiAttendanceGroupUsersRemoveRequest : BaseDingTalkRequest<DingTalk.Api.Response.OapiAttendanceGroupUsersRemoveResponse>
    {
        /// <summary>
        /// 考勤组id
        /// </summary>
