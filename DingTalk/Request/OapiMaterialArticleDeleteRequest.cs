...
{
    /// <summary>
    /// TOP API: dingtalk.oapi.material.article.delete
    /// </summary>
    public class OapiMaterialArticleDeleteRequest : BaseDingTalkRequest<DingTalk.Api.Response.OapiMaterialArticleDeleteResponse>
    {
        /// <summary>
        /// 文章id
        /// </summary>
