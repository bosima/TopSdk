...
{
    /// <summary>
    /// TOP API: dingtalk.oapi.ats.plugin.statistics.resume.list
    /// </summary>
    public class OapiAtsPluginStatisticsResumeListRequest : BaseDingTalkRequest<DingTalk.Api.Response.OapiAtsPluginStatisticsResumeListResponse>
    {
        /// <summary>
        /// 招聘业务标识
        /// </summary>
