...
{
    /// <summary>
    /// TOP API: dingtalk.smartwork.checkin.record.get
    /// </summary>
    public class SmartworkCheckinRecordGetRequest : BaseDingTalkRequest<DingTalk.Api.Response.SmartworkCheckinRecordGetResponse>
    {
        /// <summary>
        /// 分页查询的游标，最开始可以传0
        /// </summary>
