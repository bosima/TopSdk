...
{
    /// <summary>
    /// TOP API: dingtalk.oapi.microapp.addwithuserid
    /// </summary>
    public class OapiMicroappAddwithuseridRequest : BaseDingTalkRequest<DingTalk.Api.Response.OapiMicroappAddwithuseridResponse>
    {
        /// <summary>
