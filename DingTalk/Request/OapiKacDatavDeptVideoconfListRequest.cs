...
{
    /// <summary>
    /// TOP API: dingtalk.oapi.kac.datav.dept.videoconf.list
    /// </summary>
    public class OapiKacDatavDeptVideoconfListRequest : BaseDingTalkRequest<DingTalk.Api.Response.OapiKacDatavDeptVideoconfListResponse>
    {
        /// <summary>
        /// 请求参数对象
        /// </summary>
