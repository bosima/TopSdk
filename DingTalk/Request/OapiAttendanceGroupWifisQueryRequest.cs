...
{
    /// <summary>
    /// TOP API: dingtalk.oapi.attendance.group.wifis.query
    /// </summary>
    public class OapiAttendanceGroupWifisQueryRequest : BaseDingTalkRequest<DingTalk.Api.Response.OapiAttendanceGroupWifisQueryResponse>
    {
        /// <summary>
        /// 上一批次最后一个id，默认空
        /// </summary>
