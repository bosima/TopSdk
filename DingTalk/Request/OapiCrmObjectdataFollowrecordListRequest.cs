...
{
    /// <summary>
    /// TOP API: dingtalk.oapi.crm.objectdata.followrecord.list
    /// </summary>
    public class OapiCrmObjectdataFollowrecordListRequest : BaseDingTalkRequest<DingTalk.Api.Response.OapiCrmObjectdataFollowrecordListResponse>
    {
        /// <summary>
        /// 操作人用户ID
        /// </summary>
