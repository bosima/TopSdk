...
{
    /// <summary>
    /// TOP API: dingtalk.oapi.isv.openencrypt.authappclose
    /// </summary>
    public class OapiIsvOpenencryptAuthappcloseRequest : BaseDingTalkRequest<DingTalk.Api.Response.OapiIsvOpenencryptAuthappcloseResponse>
    {
        /// <summary>
        /// 请求参数
        /// </summary>
