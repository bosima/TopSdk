...
{
    /// <summary>
    /// TOP API: dingtalk.oapi.alitrip.btrip.flight.order.search
    /// </summary>
    public class OapiAlitripBtripFlightOrderSearchRequest : BaseDingTalkRequest<DingTalk.Api.Response.OapiAlitripBtripFlightOrderSearchResponse>
    {
        /// <summary>
        /// 请求对象
        /// </summary>
