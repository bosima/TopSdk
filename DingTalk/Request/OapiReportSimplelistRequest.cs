...
{
    /// <summary>
    /// TOP API: dingtalk.oapi.report.simplelist
    /// </summary>
    public class OapiReportSimplelistRequest : BaseDingTalkRequest<DingTalk.Api.Response.OapiReportSimplelistResponse>
    {
        /// <summary>
