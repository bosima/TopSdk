...
{
    /// <summary>
    /// TOP API: dingtalk.oapi.rhino.mos.space.device.check.out
    /// </summary>
    public class OapiRhinoMosSpaceDeviceCheckOutRequest : BaseDingTalkRequest<DingTalk.Api.Response.OapiRhinoMosSpaceDeviceCheckOutResponse>
    {
        /// <summary>
