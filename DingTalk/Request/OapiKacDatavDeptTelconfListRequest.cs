...
{
    /// <summary>
    /// TOP API: dingtalk.oapi.kac.datav.dept.telconf.list
    /// </summary>
    public class OapiKacDatavDeptTelconfListRequest : BaseDingTalkRequest<DingTalk.Api.Response.OapiKacDatavDeptTelconfListResponse>
    {
        /// <summary>
        /// 请求参数对象
        /// </summary>
