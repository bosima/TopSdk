...
{
    /// <summary>
    /// TOP API: dingtalk.oapi.attendance.vacation.type.create
    /// </summary>
    public class OapiAttendanceVacationTypeCreateRequest : BaseDingTalkRequest<DingTalk.Api.Response.OapiAttendanceVacationTypeCreateResponse>
    {
        /// <summary>
        ...
        /// </summary>
        public Nullable<bool> FreedomLeave { get; set; }
        ...
        public LeaveCertificateDomain LeaveCertificate_ { set { this.LeaveCertificate = TopUtils.ObjectToJson(value); } } 
        ...
        public override IDictionary<string, string> GetParameters()
        {
            ...
            parameters.Add("freedom_leave", this.FreedomLeave);
        ...
        public override void Validate()
        {
            ...
            RequestValidator.ValidateRequired("hours_in_per_day", this.HoursInPerDay);
            RequestValidator.ValidateRequired("leave_name", this.LeaveName);
            RequestValidator.ValidateRequired("leave_view_unit", this.LeaveViewUnit);
            RequestValidator.ValidateRequired("natural_day_leave", this.NaturalDayLeave);
            RequestValidator.ValidateRequired("op_userid", this.OpUserid);
            RequestValidator.ValidateObjectMaxListSize("visibility_rules", this.VisibilityRules, 100);
        }
...
public class SubmitTimeRuleVODomain : TopObject
{
	...
	/// <summary>
/// LeaveCertificateDomain Data Structure.
/// </summary>
[Serializable]

public class LeaveCertificateDomain : TopObject
{
	        /// <summary>
	        /// 超过多长时间需提供请假证明
	        /// </summary>
