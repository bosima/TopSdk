...
{
    /// <summary>
    /// TOP API: dingtalk.oapi.im.chat.scenegroup.template.close
    /// </summary>
    public class OapiImChatScenegroupTemplateCloseRequest : BaseDingTalkRequest<DingTalk.Api.Response.OapiImChatScenegroupTemplateCloseResponse>
    {
        /// <summary>
        /// 启用模式
        /// </summary>
