...
{
    /// <summary>
    /// TOP API: dingtalk.oapi.crm.objectdata.contact.list
    /// </summary>
    public class OapiCrmObjectdataContactListRequest : BaseDingTalkRequest<DingTalk.Api.Response.OapiCrmObjectdataContactListResponse>
    {
        /// <summary>
        /// 操作人用户ID
        /// </summary>
