...
{
    /// <summary>
    /// TOP API: dingtalk.oapi.workspace.auditlog.list
    /// </summary>
    public class OapiWorkspaceAuditlogListRequest : BaseDingTalkRequest<DingTalk.Api.Response.OapiWorkspaceAuditlogListResponse>
    {
        /// <summary>
        ...
        public override IDictionary<string, string> GetParameters()
        {
            ...
            parameters.Add("load_more_bizId", this.LoadMoreBizId);
