...
{
    /// <summary>
    /// TOP API: dingtalk.oapi.ats.statistics.job.list
    /// </summary>
    public class OapiAtsStatisticsJobListRequest : BaseDingTalkRequest<DingTalk.Api.Response.OapiAtsStatisticsJobListResponse>
    {
        /// <summary>
        /// 招聘业务标识
        /// </summary>
