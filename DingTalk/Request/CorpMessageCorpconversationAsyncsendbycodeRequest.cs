...
{
    /// <summary>
    /// TOP API: dingtalk.corp.message.corpconversation.asyncsendbycode
    /// </summary>
    public class CorpMessageCorpconversationAsyncsendbycodeRequest : BaseDingTalkRequest<DingTalk.Api.Response.CorpMessageCorpconversationAsyncsendbycodeResponse>
    {
        /// <summary>
        /// 微应用的id
        /// </summary>
