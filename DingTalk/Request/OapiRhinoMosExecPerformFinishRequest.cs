...
{
    /// <summary>
    /// TOP API: dingtalk.oapi.rhino.mos.exec.perform.finish
    /// </summary>
    public class OapiRhinoMosExecPerformFinishRequest : BaseDingTalkRequest<DingTalk.Api.Response.OapiRhinoMosExecPerformFinishResponse>
    {
        /// <summary>
        /// 工序执行设备列表
        /// </summary>
        ...
        public override IDictionary<string, string> GetParameters()
        {
            ...
            parameters.Add("process_cost_time", this.ProcessCostTime);
