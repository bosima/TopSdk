...
{
    /// <summary>
    /// TOP API: dingtalk.oapi.attendance.vacation.quota.list
    /// </summary>
    public class OapiAttendanceVacationQuotaListRequest : BaseDingTalkRequest<DingTalk.Api.Response.OapiAttendanceVacationQuotaListResponse>
    {
        /// <summary>
        /// 假期类型唯一标识
        /// </summary>
