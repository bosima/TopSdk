...
{
    /// <summary>
    /// TOP API: dingtalk.oapi.microapp.scope.delete
    /// </summary>
    public class OapiMicroappScopeDeleteRequest : BaseDingTalkRequest<DingTalk.Api.Response.OapiMicroappScopeDeleteResponse>
    {
        /// <summary>
        /// 应用id
        /// </summary>
