...
{
    /// <summary>
    /// TOP API: dingtalk.oapi.rhino.mos.layout.operationdefs.next
    /// </summary>
    public class OapiRhinoMosLayoutOperationdefsNextRequest : BaseDingTalkRequest<DingTalk.Api.Response.OapiRhinoMosLayoutOperationdefsNextResponse>
    {
        /// <summary>
