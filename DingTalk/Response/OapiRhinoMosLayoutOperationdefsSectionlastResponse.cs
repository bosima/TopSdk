...
{
    /// <summary>
    /// OapiRhinoMosLayoutOperationdefsSectionlastResponse.
    /// </summary>
    public class OapiRhinoMosLayoutOperationdefsSectionlastResponse : DingTalkResponse
    {
        /// <summary>
        /// 错误码
        /// </summary>
...
{
	        /// <summary>
	        /// 适用尺码（即将废弃，后续前移到applicable_size_list）
	        /// </summary>
