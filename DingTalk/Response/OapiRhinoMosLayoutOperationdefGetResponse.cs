...
{
    /// <summary>
    /// OapiRhinoMosLayoutOperationdefGetResponse.
    /// </summary>
    public class OapiRhinoMosLayoutOperationdefGetResponse : DingTalkResponse
    {
        /// <summary>
        /// 错误码
        /// </summary>
        ...
        /// </summary>
        [XmlElement("result")]
        public OperationDefDtoDomain Result { get; set; }
