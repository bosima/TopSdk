...
{
    /// <summary>
    /// OapiRhinoMosLayoutOperationdefGetflowResponse.
    /// </summary>
    public class OapiRhinoMosLayoutOperationdefGetflowResponse : DingTalkResponse
    {
        /// <summary>
        /// 错误码
        /// </summary>
        ...
        /// </summary>
        [XmlElement("result")]
        public OperationDefFlowDtoDomain Result { get; set; }
...
public class OperationDefDtoDomain : TopObject
{
	...
	/// <summary>
/// OperationDefFlowDtoDomain Data Structure.
/// </summary>
[Serializable]

public class OperationDefFlowDtoDomain : TopObject
{
	        /// <summary>
	        /// 是否激活/最大版本
	        /// </summary>
	        ...
	        /// 工序定义列表
	        /// </summary>
	        [XmlArray("operation_defs")]
	        [XmlArrayItem("operation_def_dto")]
	        public List<OperationDefDtoDomain> OperationDefs { get; set; }
